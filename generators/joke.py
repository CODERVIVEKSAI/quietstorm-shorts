...
def _prompt() -> str:
    return """Write a 130-160 word joke routine that lands in ~50 seconds as a YouTube Short.
...
Return JSON:
- script: full voiceover (130-160 words, setup + tangent + payoff + tiny beat)
